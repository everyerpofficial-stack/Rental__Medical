...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-muted/30 [&_tr]:border-b [&_tr]:border-border-strong/70",
      className,
    )}
    {...props}
  />
  ...
  ({ className, ...props }, ref) => (
    <tr
      ...
      className={cn(
        ...
        "hover:bg-muted/50 data-[state=selected]:bg-primary/[0.05]",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-4 text-left align-middle text-[11px] font-semibold uppercase tracking-[0.055em] text-muted-foreground/70",
