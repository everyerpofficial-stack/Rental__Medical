    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <div className="grid gap-4 py-2 sm:grid-cols-2">
          {hasDraft && (
            <div className="sm:col-span-2 flex items-center justify-between bg-primary/10 border border-primary/20 text-primary p-3 rounded-lg text-xs font-semibold mb-2">
          ...
          {/* Rent End Date is removed from the form as it is ongoing until return */}
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5 sm:col-span-2 rounded-lg border border-border/60 bg-muted/20 p-3 mb-2">
            ...
            {isNewCustomer ? (
              <div className="grid gap-3 sm:grid-cols-2 mt-3 pt-3 border-t border-border/50">
                {/* Bug 4 fix: Field order — Full Name → Address → Contact */}
