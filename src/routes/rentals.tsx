...
import {
  ...
  X, QrCode, Phone, Info, Users, CreditCard, ArrowLeft, ArrowRight
} from "lucide-react";
import {
  getRentals,
  saveRental,
...
function CreateRentalDialog({ trigger, title = "New Rental Agreement", rental, onSave, inline, onClose }: {
  ...
  const handleSetMobileStep = (step: number) => {
    setMobileStep(step);
    ...
    <div className="space-y-4 animate-[fade-in_0.3s_ease-out]">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mt-4 items-start relative">
        ...
        <div className="flex-1 space-y-4">
            {hasDraft && (!isMobileView || mobileStep === 1) && (
                ...
                <>
                  ...
                  {isMobileView && (
                    <div className="col-span-2 pt-2">
                      <Button type="button" className="w-full h-10 font-bold" onClick={() => handleSetMobileStep(2)}>
                        Next: Select Equipment <ArrowRight className="ml-1.5 h-4 w-4" />
                      </Button>
                    </div>
                  )}
                </>
            ...
            {(!isMobileView || mobileStep === 2) && (
              <>
                ...
                <div className="sm:col-span-2 flex flex-col sm:flex-row sm:items-center justify-between border-b border-border pb-2 mt-2 gap-2">
                  <div className="flex flex-col">
                    <Label className="text-[12px] font-bold uppercase tracking-wider text-foreground">
                      Equipment Selection
                    </Label>
                  </div>
                  <div className="grid grid-cols-3 gap-1.5 sm:flex sm:gap-2">
                    <EquipmentFormDialog
                      ...
                      trigger={
                        <Button
                          ...
                          size="sm"
                          type="button"
                          className="h-8.5 text-[11.5px] text-primary border-primary/20 hover:bg-primary/5 px-1 justify-center shadow-xs"
                        >
                          <Plus className="mr-0.5 h-3.5 w-3.5 shrink-0" />
                    ...
                    >
                      <QrCode className="mr-0.5 h-3.5 w-3.5 shrink-0" />
                      <span className="hidden sm:inline">Scan Equipment</span>
                ...
                <div className="sm:col-span-2 space-y-4">
                  {selectedEquipments.map((eqItem, idx) => {
                    ...
                    return (
                      <div key={idx} className="grid gap-3 grid-cols-2 sm:grid-cols-6 items-end p-3.5 rounded-xl border border-border bg-card/50 relative group shadow-xs">
                        {selectedEquipments.length > 1 && (
                          <Button
                            variant="ghost"
                            size="icon"
                            type="button"
                            className="absolute top-2 right-2 h-9 w-9 text-muted-foreground hover:text-destructive z-10"
                            onClick={(e) => {
                              e.preventDefault();
                        ...
                        {(() => {
                          ...
                          return (
                            <div className="col-span-2 sm:col-span-6 flex flex-wrap items-center gap-x-5 gap-y-1.5 text-[11.5px] bg-primary/5 border border-primary/15 rounded-lg px-3.5 py-2 mt-0.5 font-medium animate-[fade-in_0.2s_ease-out]">
                ...
                {isMobileView && (
                  <div className="flex gap-3 pt-2">
                    <Button type="button" variant="outline" className="flex-1 h-10 font-bold" onClick={() => handleSetMobileStep(1)}>
                      <ArrowLeft className="mr-1.5 h-4 w-4" /> Back
                    </Button>
                    <Button type="button" className="flex-[2] h-10 font-bold" onClick={() => handleSetMobileStep(3)}>
                      Next: Charges & Payment <ArrowRight className="ml-1.5 h-4 w-4" />
                    </Button>
                  </div>
                )}
              </>
            ...
            {(!isMobileView || mobileStep === 3) && (
              <>
                ...
                {isMobileView && (
                  <div className="flex gap-3 pt-2">
                    <Button type="button" variant="outline" className="flex-1 h-10 font-bold" onClick={() => handleSetMobileStep(2)}>
                      <ArrowLeft className="mr-1.5 h-4 w-4" /> Back
                    </Button>
                    <Button type="button" className="flex-[2] h-10 font-bold" onClick={() => handleSetMobileStep(4)}>
                      Next: Verification <ArrowRight className="ml-1.5 h-4 w-4" />
                    </Button>
                  </div>
                )}
              </>
            ...
            {(!isMobileView || mobileStep === 4) && (
              <>
                {/* Security & Verification */}
                <div className="sm:col-span-2 space-y-3 rounded-lg border border-border/60 bg-muted/10 p-4 mt-2 shadow-xs">
                ...
                {isMobileView && (
                  <div className="col-span-2 flex gap-3 pt-2">
                    <Button type="button" variant="outline" className="flex-1 h-10 font-bold" onClick={() => handleSetMobileStep(3)}>
                      <ArrowLeft className="mr-1.5 h-4 w-4" /> Back
                    </Button>
                    <Button type="button" className="flex-[2] h-10 font-bold" onClick={() => handleSetMobileStep(5)}>
                      Next: Review & Save <ArrowRight className="ml-1.5 h-4 w-4" />
                    </Button>
                  </div>
                )}
              </>
            ...
            <div className="w-full lg:w-[340px] shrink-0 flex flex-col justify-between border-t lg:border-t-0 lg:border-l border-border pt-4 lg:pt-0 lg:pl-6 gap-4 min-h-0 lg:sticky lg:top-4 lg:self-start">
              ...
              <div className="flex flex-col gap-2 mt-auto border-t pt-4">
                ...
                <div className="flex gap-2 w-full mt-2">
                  {isMobileView && (
                    <Button type="button" variant="outline" className="flex-1 font-bold h-10" onClick={() => handleSetMobileStep(4)}>
                      <ArrowLeft className="mr-1.5 h-4 w-4" /> Back
                    </Button>
                  )}
                  <Button variant="outline" type="button" className="flex-1 font-semibold h-10" onClick={onClose}>Cancel</Button>
                  {!isStaff && rental && rental.status === "Pending Approval" && (
                    <Button 
                      type="button" 
                      className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white text-[12px] px-2 font-bold h-10" 
                      onClick={() => {
                  ...
                  <Button type="button" className="flex-1 font-bold h-10" onClick={handleSave} disabled={isSubmitting}><FileText className="mr-1.5 h-3.5 w-3.5" />Save</Button>
                </div>
              </div>
            </div>
          )}
