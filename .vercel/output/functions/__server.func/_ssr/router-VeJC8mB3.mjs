...
import { ct as SHEETS, ft as isGSheetsEnabled, gt as syncRowToSheet, pt as sendOtpEmail } from "./data-store-BQmZefNN.mjs";
...
import { n as Route$12 } from "./rentals-BPcVrQON.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-VeJC8mB3.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-BuklNCow.css";
...
function LoginInterface({ onLoginSuccess }) {
	...
	const handleVerifyCredentials = async (e) => {
		...
		if (!foundUser && isGSheetsEnabled()) try {
			const { syncFromSheetsToLocalStorage } = await import("./data-store-BQmZefNN.mjs").then((n) => n.a);
...
function RootComponent() {
	...
	const checkSetupAndAuth = () => {
		...
		if (isGSheetsEnabled()) import("./data-store-BQmZefNN.mjs").then((n) => n.a).then(({ syncFromSheetsToLocalStorage }) => {
